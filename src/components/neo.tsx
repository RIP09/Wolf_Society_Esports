...
const STATUS_COLORS: Record<string, string> = {
  ...
  present: "bg-neo-green text-white",
  late: "bg-neo-orange text-white",
  absent: "bg-neo-red text-white",
  leave: "bg-neo-blue text-white",
  auto: "bg-neo-red text-white",
  manual: "bg-neo-green text-white",
